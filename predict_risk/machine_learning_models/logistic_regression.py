...
DIR='D:/Heart-disease-prediction-master/predict_risk/machine_learning_models'

def LogisticRegression(source_file,input):
    dataset = pd.read_csv(DIR+'/'+source_file)
